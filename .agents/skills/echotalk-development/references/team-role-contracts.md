...
The PM/main agent owns coordination and the single sprint status record.
...
Own sprint scope, dependencies, assignments, gates, risk register, status, and
...
- Shared contracts are Architect-owned until frozen; shared sprint status is
