...
Tamil is a future language track unless a sprint explicitly brings it into scope.
...
Targets belong in the active sprint charter after baseline measurement. Do not
