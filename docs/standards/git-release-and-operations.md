# Git, Release, and Operations

## Branch and review policy

- Keep `main` protected and releasable; use pull requests for changes. Require
  human review for the authority registry and pinned public keys.
- Create one scoped branch/worktree per task. Default branch form:
  `charithm/<feature>-<stage>-<short-purpose>`.
...
Use `docs/governance/templates/task.md`. Do not rely on chat history as the
only handoff record.
