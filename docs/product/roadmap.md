...
## F000 / S00 — Delivery and environment foundation
...
inventory, and fail-closed QA/UAT/release evidence contracts. Exit with
independent QA and human UAT of the delivery workflow; this stage does not
deploy the voice application.

## F001 / S01 — Secure platform baseline

Remediate and retest production dependency vulnerabilities, then add
identity/session authorization, durable metadata, Redis ephemeral state, secret
management, rate/spend controls, consent/retention foundations, structured
