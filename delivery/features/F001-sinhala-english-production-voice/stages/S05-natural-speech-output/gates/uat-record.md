...
- Production release authorized: pending human input
- Client comments:
- Client name:
- Date:
- Recorded evidence:
...
Agents must leave the decision and production-permission fields pending until
the named human client explicitly supplies them.
