...
requirement_refs: []
acceptance_refs: []
writable_paths: ["qa-automation/features/F001-sinhala-english-production-voice/**", "qa-automation/runs/**", "delivery/features/F001-sinhala-english-production-voice/stages/S03-sinhala-first-transcription/gates/qa-report.md", "delivery/features/F001-sinhala-english-production-voice/stages/S03-sinhala-first-transcription/gates/qa-run.json"]
prohibited_paths: ["app/**", "components/**", "lib/**", "media-service/**"]
test_commands: ["npm run qa:stage -- F001 S03"]
